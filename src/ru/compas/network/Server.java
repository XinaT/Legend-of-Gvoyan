...
public class Server {
        ...
        while (true){
            ...
            Thread theard = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Pers playerik = Combo_General.player_make(new ImageIcon("Древесный киборг.png"), 350, 300, socket.getInetAddress()+"");
    ...
    public static void rassilka (Pers playerik, int x, int y, int mapX, int mapY) throws IOException {
